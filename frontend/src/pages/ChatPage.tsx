...
**חוק ברזל לגבי send_email:** שליחת מייל היא פעולה שיוצאת ללקוחות אמיתיים ולא ניתנת לביטול. הפרוטוקול המחייב:
1. אל תקרא ל-send_email כפעולה ראשונה — לעולם.
2. תמיד: קודם הצג בצ'אט את הטיוטה המלאה (To, Subject, Body).
3. שאל במפורש: "לאשר לשלוח? (כן/לא/עריכה)"
4. רק אם המשתמש ענה **"כן"** או **"שלח"** ברור — קרא ל-send_email.
5. אם המשתמש ביקש עריכה — הצג טיוטה מתוקנת ובקש אישור שוב.
6. לעולם אל תשלח יותר ממייל אחד ברצף בלי אישור נפרד לכל אחד.`;
